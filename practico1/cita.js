...
console.log('El tamaño de la cita es: ' + tamañoCita); // El tamaño de la cita es: 44 
let indice = cita.indexOf(substring);
console.log('El indice del substring es: ' + indice); // El indice del substring es: 13 
let citaRevisada = cita.slice('Tres tristes tigres comen trigo');
console.log(citaRevisada) // Tres tristes tigres comen trigo en un trigal 